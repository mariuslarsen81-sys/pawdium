...
export const mockDogs: Dog[] = [
  {
    ...
    ribbons: [
      ...
      { color: "#C9A84C", label: "Best of Breed", year: 2024 },
      { color: "#DC2626", label: "1st Open Bitch", year: 2023 },
      { color: "#C9A84C", label: "Best of Breed", year: 2023 },
      { color: "#9333EA", label: "Reserve CC", year: 2023 },
      { color: "#DC2626", label: "Challenge Certificate", year: 2023 },
      { color: "#DC2626", label: "Challenge Certificate", year: 2022 },
      { color: "#9333EA", label: "Reserve CC", year: 2022 },
      { color: "#16A34A", label: "Junior Warrant", year: 2022 },
      { color: "#DC2626", label: "1st Minor Puppy", year: 2021 },
      { color: "#DC2626", label: "Best Puppy in Breed", year: 2021 },
      { color: "#F59E0B", label: "Group 3", year: 2024 },
    ],
    results: [
      {
        show: "Crufts 2024",
  ...
  },
  {
    ...
    ribbons: [
      ...
      { color: "#C9A84C", label: "Best of Breed", year: 2024 },
      { color: "#F59E0B", label: "Group 2", year: 2024 },
      { color: "#DC2626", label: "Challenge Certificate", year: 2023 },
      { color: "#C9A84C", label: "Best of Breed", year: 2023 },
      { color: "#DC2626", label: "Challenge Certificate", year: 2023 },
      { color: "#F59E0B", label: "Group 1", year: 2022 },
      { color: "#C9A84C", label: "Best of Breed", year: 2022 },
      { color: "#DC2626", label: "Challenge Certificate", year: 2022 },
      { color: "#9333EA", label: "Reserve CC", year: 2021 },
