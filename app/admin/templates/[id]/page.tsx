    ...
    <div className="px-5 py-8 max-w-2xl mx-auto">
      ...
      <div className="bg-plum-800 border border-plum-700 rounded-xl p-5 mb-4">
        <div className="grid grid-cols-2 gap-3 mb-4">
          <div>
            <label className="block text-xs text-stone/45 mb-1.5">Type</label>
        ...
        <div className="mb-4">
          <label className="block text-xs text-stone/45 mb-1.5">Subject line</label>
          <input className={inp} value={tmpl.subject ?? ""} onChange={e => set("subject", e.target.value)} placeholder="Email subject…" />
        </div>
        <div>
          <div className="flex items-center justify-between mb-1.5">
            <label className="block text-xs text-stone/45">Message body</label>
            {!isNew && tmpl.body && (
